...
- (NSString *)googleURLString {
    ...
    NSMutableString *url = [NSMutableString stringWithFormat:@"%@/maps/api/place/details/json?reference=%@&sensor=%@&key=%@",
                            baseUrl, self.reference, SPBooleanStringForBool(self.sensor), self.key];
    if (self.language) {
